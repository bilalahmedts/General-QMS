                    ...
                    <table class="table table-hover">
                        @foreach ($category as $item)
                            ...
                            <tr>
                                ...
                                <td class="radios">
                                    <label class="radio-inline qrating"><input type="radio" class="radio" value="1" name="answer-{{ $item->id }}" @if($item->answer >= 1 && $item->answer != 6) checked @else disabled @endif>Yes</label>

<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="number" maxlength="5" class="form-control" maxlength="5" placeholder="Customer Rating" name="customer_rating" value="{{ $voice_audit->customer_rating }}" required>
        </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Customer Feedback" name="customer_feedback" value="{{ $voice_audit->customer_feedback }}" required>
        </div>

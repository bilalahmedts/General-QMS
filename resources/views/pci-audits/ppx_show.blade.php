...
@section('content')
    ...
    <div class="search-area">
        <div class="row">
            ...
            <div class="col-md-6">
                <h4 class="mb-0">PCI Audit Detail</h4>
            </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body table-responsive">
                    ...
                    @include('pci-audits.include.evaluation-review-detail', ['voice_audit' => $voice_audit])
        ...
        <div class="col-md-8">
            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card-body">
                    ...
                    @include('pci-audits.include.evaluation-review-points', ['voice_audit' => $voice_audit, 'categories' => $categories])
